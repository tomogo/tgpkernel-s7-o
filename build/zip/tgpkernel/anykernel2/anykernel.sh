...
if egrep -q "install=1" "/tmp/aroma/selinux.prop"; then
	...
	replace_string $ramdisk/sbin/tgpkernel.sh "setenforce 1" "setenforce 0" "setenforce 1"
	replace_string sbin/tgpkernel.sh "echo \"1\" > /sys/fs/selinux/enforce" "echo \"0\" > /sys/fs/selinux/enforce" "echo \"1\" > /sys/fs/selinux/enforce"
	replace_string sbin/tgpkernel.sh "chmod 644 /sys/fs/selinux/enforce" "chmod 640 /sys/fs/selinux/enforce" "chmod 644 /sys/fs/selinux/enforce"
fi
